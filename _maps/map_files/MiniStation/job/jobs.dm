...
/datum/job/New()
	..()
	supervisors = "kapitan i glowa personelu"
...
/datum/job/captain/New()
	..()
	supervisors = "zarzad firmy NanoTrasen"

/datum/job/hop/New()
	..()
	supervisors = "kapitan i zarzad firmy NanoTrasen"
...
/datum/job/chaplain/New()
	...
	total_positions = 1
	spawn_positions = 1
	access = list(access_morgue, access_chapel_office)
	minimal_access = list(access_morgue, access_chapel_office)
