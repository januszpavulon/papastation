...
/atom/movable/proc/say_quote(input, list/spans=list())
	if(!input)
		return "mowi, \"...\""	//not the best solution, but it will stop a large number of runtimes. The cause is somewhere in the Tcomms code
