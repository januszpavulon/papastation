...
/datum/crewmonitor/New()
	...
	jobs["Kapitan"] = 00
	jobs["Szef Personelu"] = 50
	jobs["Szef Ochrony"] = 10
	jobs["Naczelnik"] = 11
	jobs["Bagieta"] = 12
	jobs["Detektyw"] = 13
	jobs["Ordynator"] = 20
	...
	jobs["Wirusolog"] = 23
	jobs["Lekarz"] = 24
	jobs["Dyrektor ds. Naukowych"] = 30
	jobs["Naukowiec"] = 31
	jobs["Robotyk"] = 32
	jobs["Glowny Inzynier"] = 40
	jobs["Inzynier"] = 41
	jobs["Technik Atmosferyczny"] = 42
	jobs["Kwatermistrz"] = 51
	jobs["Gornik"] = 52
	jobs["Magazynier"] = 53
	jobs["Barman"] = 61
	jobs["Kucharz"] = 62
	jobs["Botanik"] = 63
	jobs["Bibliotekarz"] = 64
	jobs["Kaplan"] = 65
	jobs["Klaun"] = 66
	jobs["Mim"] = 67
	jobs["Wozny"] = 68
	...
	jobs["Guwniak"] = 999 //Unknowns/custom jobs should appear after civilians, and before assistants
