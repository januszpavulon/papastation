...
/obj/machinery/computer/card/Topic(href, href_list)
	...
	switch(href_list["choice"])
		...
		if ("demote")
			if(modify.assignment in head_subordinates || modify.assignment == "Guwniak")
