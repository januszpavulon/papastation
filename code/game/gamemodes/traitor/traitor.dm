...
/datum/game_mode/proc/equip_traitor(mob/living/carbon/human/traitor_mob, safety = 0)
	...
	. = 1
	if (traitor_mob.mind)
		if (traitor_mob.mind.assigned_role == "Klaun")
	...
	if (!I)
		...
		if(istype(I, /obj/item/device/radio))
			...
			traitor_mob << "Syndykat ukryl w twoim [R.name] [loc] specjalne urzadzenie pozwalajace na zakup specjalnych przedmiotow. Wystarczy ze wybierzesz czestotliwosc [format_frequency(R.traitor_frequency)] a odblokujesz ekran zakupu przedmiotow."
			...
			traitor_mob << "Syndykat ukryl w twoim [P.name] [loc] specjalne urzadzenie pozwalajace na zakup specjalnych przedmiotow. Wystarczy ze wpiszesz \"[P.lock_code]\" w ekranie zmiany dzwonka a odblokujesz ekran zakupu przedmiotow."
