...
/proc/is_convertable_to_cult(datum/mind/mind)
	...
	if(istype(mind.current, /mob/living/carbon/human) && (mind.assigned_role in list("Kapitan", "Kaplan")))	return 0
...
/datum/game_mode/cult
	...
	restricted_jobs = list("Kaplan","AI", "Cyborg", "Bagieta", "Naczelnik", "Detektyw", "Szef Ochrony", "Kapitan", "Szef Personelu")
	protected_jobs = list()
	required_players = 30
	required_enemies = 4
...
/datum/game_mode/proc/equip_cultist(mob/living/carbon/human/mob,tome = 0)
	...
	mob.cult_add_comm()
	if (mob.mind)
		if (mob.mind.assigned_role == "Klaun")
