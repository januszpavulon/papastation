...
/proc/power_failure()
	priority_announce("Dziwna aktywnosc wykryta w systemach elektrycznych na pokladzie [station_name()]. W celach zapobiegawczych prad zostanie wylaczony na nieokreslony czas.", "Blad Krytyczny", 'sound/AI/poweroff.ogg')
...
/proc/power_restore()
	...
	priority_announce("Prad elektryczny przywrocony na [station_name()]. Pzepraszamy za klopoty.", "Systemy Naprawione", 'sound/AI/poweron.ogg')
...
/proc/power_restore_quick()
	...
	priority_announce("Wszystkie urzadzenia SMES na [station_name()] zostaly naladowane. Przepraszamy za klopoty.", "Systemy Naprawione", 'sound/AI/poweron.ogg')
	for(var/obj/machinery/power/smes/S in machines)
		if(S.z != ZLEVEL_STATION)
			continue
		S.charge = S.capacity
