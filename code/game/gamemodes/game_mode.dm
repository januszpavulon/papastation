...
/datum/game_mode/proc/convert_roundtype()
	...
	if(config.protect_assistant_from_antagonist)
		replacementmode.restricted_jobs += "Guwniak"
...
/datum/game_mode/proc/send_intercept()
	...
	priority_announce("Wiecej informacji wydrukowano i mo¿na je znalezc przy kazdej konsoli komunikacyjnej.", "Przechwycono wrogie meldunki. Poziom bezpieczenstwa podniesiony.", 'sound/AI/intercept.ogg')
