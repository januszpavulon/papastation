...
/proc/make_maint_all_access()
	for(var/area/maintenance/A in world)
		for(var/obj/machinery/door/airlock/D in A)
			D.emergency = 1
			D.update_icon(0)
	minor_announce("Zniesiono ograniczenia dostepu do tuneli naprawczych.", "Uwaga! Stan wyjatkowy na calej stacji:",1)
	emergency_access = 1
...
/proc/revoke_maint_all_access()
	for(var/area/maintenance/A in world)
		for(var/obj/machinery/door/airlock/D in A)
			D.emergency = 0
			D.update_icon(0)
	minor_announce("Ograniczenia dostepu do tuneli naprawczych przywrocone.", "Uwaga! Stan wyjatkowy zniesiony:")
	emergency_access = 0
