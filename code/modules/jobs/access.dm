...
/proc/get_all_jobs()
	return list("Guwniak", "Kapitan", "Szef Personelu", "Barman", "Kucharz", "Botanik", "Kwatermistrz", "Magazynier",
				"Gornik", "Klaun", "Mim", "Wozny", "Bibliotekarz", "Prawnik", "Kaplan", "Glowny Inzynier", "Inzynier",
				"Technik Atmosferyczny", "Ordynator", "Lekarz", "Chemik", "Genetyk", "Wirusolog",
				"Dyrektor ds. Naukowych", "Naukowiec", "Robotyk", "Szef Ochrony", "Naczelnik", "Detektyw", "Bagieta")
