...
/mob/living/simple_animal/bot/secbot/proc/cuff(mob/living/carbon/C)
	...
	C.visible_message("<span class='danger'>[src] proboje zakuc [C]!</span>",\
						"<span class='userdanger'>[src] proboje cie zakuc!</span>")
	spawn(60)
		...
		if(!C.handcuffed)
			...
			C.update_handcuffed()
			playsound(loc, pick('sound/voice/bgod.ogg', 'sound/voice/biamthelaw.ogg', 'sound/voice/bsecureday.ogg', 'sound/voice/bradio.ogg', 'sound/voice/binsult.ogg'), 50, 0)
			back_to_idle()
...
/mob/living/simple_animal/bot/secbot/proc/stun_attack(mob/living/carbon/C)
	...
	if(declare_arrests)
		...
		speak("[arrest_type ? "Zatrzymuje" : "Aresztuje"] przestepce poziomu [threat] <b>[C]</b> w [location].", radio_channel)
	C.visible_message("<span class='danger'>[src] obezwladnil [C]!</span>",\
							"<span class='userdanger'>[src] cie obezwladnil!</span>")
...
/mob/living/simple_animal/bot/secbot/proc/look_for_perp()
	...
	for (var/mob/living/carbon/C in view(7,src)) //Let's find us a criminal
		...
		if(!threatlevel)
			...
			speak("Wykryto przestepce poziomu [threatlevel]!")
			playsound(loc, pick('sound/voice/bcriminal.ogg', 'sound/voice/bjustice.ogg', 'sound/voice/bfreeze.ogg', 'sound/voice/bcreep.ogg'), 50, 0)
			visible_message("<b>[src]</b> odwraca sie w kierunku [C.name]!")
			mode = BOT_HUNT
			spawn(0)
...
/mob/living/simple_animal/bot/secbot/explode()
	...
	walk_to(src,0)
	visible_message("<span class='boldannounce'>[src] eksploduje!</span>")
	var/turf/Tsec = get_turf(src)
