...
/mob/living/simple_animal/hostile/alien/proc/SpreadPlants()
	...
	if(locate(/obj/structure/alien/weeds/node) in get_turf(src))
		return
	visible_message("<span class='alertalien'>[src] stworzyl chwasty!</span>")
...
/mob/living/simple_animal/hostile/alien/proc/LayEggs()
	...
	if(locate(/obj/structure/alien/egg) in get_turf(src))
		return
	visible_message("<span class='alertalien'>[src] zlozyl jajo!</span>")
...
/mob/living/simple_animal/hostile/alien/death(gibbed)
	..(gibbed)
	visible_message("[src] wydaje denerwujacy skrzek, po czym upada z zielona krwia lejaca sie z pyska...")
