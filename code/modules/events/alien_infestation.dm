...
/datum/round_event/alien_infestation/announce()
	if(successSpawn)
		priority_announce("Niezidentyfikowane formy zycia wykryte na pokladzie [station_name()]. Prosimy o zabezpieczenie wszelkich krat wentylacyjnych.", "Niezidentyfikowane formy zycia", 'sound/AI/aliens.ogg')
