...
/datum/round_event/brand_intelligence/announce()
	priority_announce("Zlosliwy wirus wykryty w jednym z automatow sprzedajacych na pokladzie [station_name()]. Prawdopodobne zrodlo to [originMachine.name].", "Watykanczyk")
