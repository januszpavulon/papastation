...
/datum/round_event/radiation_storm/announce()
	priority_announce("Wysokie poziomy promieniowania wykryte nieopodal stacji. Prosimy o schronienie sie w tunelach naprawczych.", "Promieniowanie", 'sound/AI/radiation.ogg')
...
/datum/round_event/radiation_storm/end()
	priority_announce("Promieniowanie minelo. Prosimy o powrot do pracy.", "Promieniowanie")