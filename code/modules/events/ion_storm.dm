...
/datum/round_event/ion_storm/announce()
	if(announceEvent == ION_ANNOUNCE || (announceEvent == ION_RANDOM && prob(ionAnnounceChance)))
		priority_announce("Burza jonowa wykryta nieopodal stacji. Prosimy o sprawdzenie sprzetow kontrolowanych przez AI i naprawienie potencjalnych bledow.", "Anomalia", 'sound/AI/ionstorm.ogg')
